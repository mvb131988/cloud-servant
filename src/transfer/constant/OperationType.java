...
public enum OperationType {
	...
	REQUEST_MASTER_STATUS_START(13),
	REQUEST_MASTER_STATUS_END(14),
	RESPONSE_MASTER_STATUS_START(15),
	RESPONSE_MASTER_STATUS_END(16),

	REQUEST_HEALTHCHECK_START(17),
	REQUEST_HEALTHCHECK_END(18),
	RESPONSE_HEALTHCHECK_START(19),
	RESPONSE_HEALTHCHECK_END(20);
